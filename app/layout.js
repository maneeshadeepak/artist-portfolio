  ...
  return (
    <html lang="en">
      <body style={{ margin: 0, fontFamily: 'system-ui, sans-serif', background: '#f4f1ec', color: '#222', overflow: open ? 'hidden' : 'auto' }}>
        <header style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '20px 24px', borderBottom: '1px solid #ddd' }}>
        ...
        <div style={{ position: 'fixed', top: 0, right: 0, width: 300, height: '100vh', padding: 32, background: '#fff', transform: open ? 'translateX(0)' : 'translateX(100%)', transition: 'transform 0.3s ease', zIndex: 100 }}>
