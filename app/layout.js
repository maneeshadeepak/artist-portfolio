  ...
  return (
    <html lang='en'>
      <body style={{ margin: 0, fontFamily: 'system-ui, sans-serif', background: '#f4f1ec', color: '#222', overflow: open ? 'hidden' : 'auto' }}>
        ...
        <div style={{ position: 'fixed', top: 0, right: 0, width: 320, height: '100vh', padding: 32, background: '#eee', transform: open ? 'translateX(0)' : 'translateX(100%)', transition: 'transform 0.35s ease', zIndex: 100 }}>
        ...
        {open && <div onClick={() => setOpen(false)} style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.3)', zIndex: 50 }} />}
